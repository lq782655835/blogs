<template>
    <div class="con-home-patreons">
        ...
        <ul>
            <li
                :class="{ patreonx: patreon.name }"
                :title="
                    patreon.name
                        ? `Proudly patronized by ${patreon.name}`
                        : 'Become a Patron - Add your logo here'
                "
                v-for="(patreon, index) in patreons"
            >
                <a
                    target="_blank"
                    :href="
                        patreon.link
                            ? patreon.link
                            : 'https://www.patreon.com/luisdanielroviracontreras'
                    "
            ...
            <li
                ...
                :title="
                    patreon.name
                        ...
                        : 'Become a Patron - Add your logo here'
                "
                v-for="(patreon, index) in patreons2"
            >
                <a
                    target="_blank"
                    :href="
        ...
        <div class="con-text-home-patreons">
            <span
                >It helps to pay dedicated development time so that I can move forward and
                evolve.</span
            >
            <a
                target="_blank"
  ...
  ul {
    ...
    li {
      ...
      &:hover {
        ...
        box-shadow: 0px 9px 28px -9px rgba(249, 104, 84, 0.5);
